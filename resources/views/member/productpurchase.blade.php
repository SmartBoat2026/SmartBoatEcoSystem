                                ...
                                <div style="background:linear-gradient(90deg,#1a3a6b,#0c447c);border-radius:8px;padding:12px 18px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;">
                                    <div style="display:flex;align-items:center;gap:10px;">
                                        ...
                                        <div>
                                            ...
                                            <div style="font-size:20px;font-weight:900;color:#fff;line-height:1.1;">₹{{ number_format($smartWalletBalance ?? 0, 2) }}</div>
                                        </div>
                                    </div>
                                    @if(($smartWalletBalance ?? 0) > 0)
                        ...
                        <tr>
                            ...
                            <td style="white-space:nowrap;">
                                ...
                                <div style="font-size:11px;color:#adb5bd;">
                                    {{ \Carbon\Carbon::parse($pur->purchase_date)->format('h:i A') }}
                                </div>
                            </td>
                            <td>
                                <span class="badge"
                            ...
                            <td style="font-size:12px;">{{ number_format($pur->total_smartquantity, 4) }}</td>
                            <td style="color:#27500a;font-weight:600;white-space:nowrap;">
                                ₹{{ number_format($pur->total, 2) }}
                            </td>
                            <td>
                                <span class="badge {{ $pur->status == 1 ? 'bg-success' : 'bg-danger' }}"
