                ...
                <table id="stpSchedulesTable"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="font-size:12px;color:#6c757d;">{{ $index + 1 }}</td>
                            <td>
                            ...
                            <td style="font-size:12px;white-space:nowrap;">{{ $schedule->end_date }}</td>
                            <td style="font-size:12px;max-width:180px;">
                                <span class="badge"
                                    ...
                                    {{ Str::limit($schedule->running_hrs, 40) }}
                                </span>
                            </td>
                            <td style="font-weight:600;color:#27500a;white-space:nowrap;">
                                ₹{{ number_format($schedule->per_hrs_amount, 2) }}
                            </td>
                            <td style="font-weight:600;color:#27500a;white-space:nowrap;">
                                ₹{{ number_format($schedule->per_day_amount, 2) }}
                            </td>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <small id="edit_selected_hrs_label_{{ $schedule->id }}" class="text-primary" style="font-size:11px;">
