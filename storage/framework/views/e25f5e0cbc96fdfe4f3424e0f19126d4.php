...
<script>
    const chatLoadUrl = "<?php echo e(route('member.chat.load.name')); ?>";
    const chatLoadHistoryUrl = "<?php echo e(route('member.chat.load.history')); ?>";
    const chatSendUrl = "<?php echo e(route('member.chat.send')); ?>";
</script>
<?php $__env->stopPush(); ?><?php /**PATH F:\xampp\htdocs\SmartBoat\ecosystemnew\resources\views/member/smartwallet/chatbox.blade.php ENDPATH**/ ?>