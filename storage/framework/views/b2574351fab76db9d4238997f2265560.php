...
$(document).ready(function () {   
    ...
    $('#receiveRfbHistoryTable').DataTable({
        processing: true,
        serverSide: false,
        ajax: "<?php echo e(route('member.smartwallet.buySell.receiveRfbListData')); ?>",
        columns: [
            { data: 'DT_RowIndex' },
            { data: 'rfb_id' },
            { data: 'amount' },
   ...
   $(document).on('click', '.accept-btn', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo e(route('member.smartwallet.buySell.acceptRequest', ':id')); ?>".replace(':id', rfbsellerId),
                    type: "POST",
                    data: {
    ...
    $(document).on('click', '.paymentReceive-btn', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo e(route('member.smartwallet.buySell.rfb.payment.receive')); ?>",
                    type: "POST",
                    data: {
    ...
    $.ajax({
        url: "<?php echo e(route('member.smartwallet.buySell.rfb.payment.details')); ?>",
        type: "POST",
        data: {
            _token: $('meta[name="csrf-token"]').attr('content'),
            rfb_seller_id: id
...
<?php echo $__env->make('member.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\xampp\htdocs\SmartBoat\ecosystemnew\Main\resources\views/member/smartwallet/receiveRequestForBuy.blade.php ENDPATH**/ ?>