            ...
            <table id="directBonusAdminTable"
                ...
                <tbody>
                    ...
                    <tr class="bonus-row-direct" style="cursor:pointer;"
                        ...
                        data-sponsor="<?php echo e($bonus->member_id); ?>"
                        ...
                        <td class="text-center">
                            <input type="checkbox" class="row-checkbox-direct" value="<?php echo e($bonus->id); ?>"
                                   style="cursor:pointer;width:15px;height:15px;"
                                   onclick="event.stopPropagation();">
                        </td>
                        <td class="text-center text-muted" style="font-size:12px;"><?php echo e($loop->iteration); ?></td>
                        <td style="font-weight:600;color:#1a3a6b;"><?php echo e($bonus->member_id); ?></td>
                        <td>
                            <span class="badge"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ecosystemneww/resources/views/admin/admindirectbonus.blade.php ENDPATH**/ ?>