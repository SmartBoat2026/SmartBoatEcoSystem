...
<!-- Plugins -->
<script src="<?php echo e(asset('public/admin/assets/plugin/chart/chart.js')); ?>"></script>
<script src="<?php echo e(asset('public/admin/assets/plugin/select2/js/select2.min.js')); ?>"></script>

<!-- Custom JS -->
<script src="<?php echo e(asset('public/admin/assets/js/chart.js')); ?>"></script>
<script src="<?php echo e(asset('public/admin/assets/js/chat.js')); ?>"></script>
<script src="<?php echo e(asset('public/admin/assets/js/board.js')); ?>"></script>
...
</html><?php /**PATH F:\xampp\htdocs\SmartBoat\ecosystemnew\Main\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>