...
<header class="sb-topbar">
    ...
    <div class="sb-topbar-right">
        ...
        <?php if(isset($lockedWalletBalance)): ?>
        <span class="sb-member-badge" id="lockedWalletBalanceForNavBar" style="
            ...
            ₹<?php echo e(number_format($lockedWalletBalance, 2)); ?>
...
<nav class="sb-sidebar" id="sidebar">
    ...
    <div class="collapse sub-menu <?php echo e(request()->routeIs('member.smartwallet.*') ? 'show' : ''); ?>"
        ...
        <div class="collapse sub-menu <?php echo e(request()->routeIs('member.smartwallet.buySell.*') ? 'show' : ''); ?>"
            ...
            <a href="<?php echo e(route('member.smartwallet.buySell.sendRequestForBuy')); ?>"
            class="nav-link ps-5 <?php echo e(request()->routeIs('member.smartwallet.buySell.sendRequestForBuy') ? 'active' : ''); ?>">
                <i class="bi bi-person"></i>
                <span class="nav-label">Sent Request For Buy</span>
            </a>

            <a href="<?php echo e(route('member.smartwallet.buySell.receiverRequestForBuy')); ?>"
            class="nav-link ps-5 <?php echo e(request()->routeIs('member.smartwallet.buySell.receiverRequestForBuy') ? 'active' : ''); ?>">
                <i class="bi bi-person"></i>
...
function goToLockWalletTab() {
    if (typeof switchTab === 'function') {
        ...
        window.location.href = "<?php echo e(route('member.profile')); ?>#lockwallet";
    }
}
function goToTransactionTab() {
    if (typeof switchTab === 'function') {
        ...
        window.location.href = "<?php echo e(route('member.profile')); ?>#transaction";
    }
}
