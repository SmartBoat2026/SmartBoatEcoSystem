 <!-- ========== NAVBAR ========== -->
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <a href="index.html" class="navbar-brand">
                    ...
                    <div class="brand-text">
                        <img src="<?php echo e(asset('admin/assets/images/panelry-logo.png')); ?>" alt="logo">
                    </div>
                </a>
            </div>
            <!-- Top nav links -->
    ...
    </header><?php /**PATH E:\xampp\htdocs\ecosystem_modifiedupdate\resources\views/admin/layouts/nav-top.blade.php ENDPATH**/ ?>