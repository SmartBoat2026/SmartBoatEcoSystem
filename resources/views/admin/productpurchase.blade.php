{{-- resources/views/admin/productpurchase.blade.php --}}
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('productpurchase.store') }}" id="purchaseForm">
                        @csrf
                        ...
                        {{-- ===== SMART WALLET BALANCE (Admin: shown after member selection) ===== --}}
...
{{-- Wallet insufficient error from server-side --}}
...
<div class="col-12 mb-2">
    <div class="alert alert-danger d-flex align-items-center gap-2 py-2 mb-0" style="font-size:12px;border-radius:6px;">
        ...
        <div><strong>Insufficient Balance!</strong> {{ $errors->first('wallet') }}</div>
    </div>
</div>
@endif
{{-- ===== END WALLET BALANCE ===== --}}
        ...
        <div class="card-body p-0">
            <div class="table-responsive p-3">
                ...
                <div id="bulkActionBar" style="display:none;background:#fff3cd;border:1px solid #ffc107;border-radius:6px;padding:10px 16px;margin-bottom:12px;align-items:center;gap:12px;">
                    ...
                    <form id="bulkDeleteForm" method="POST" action="{{ route('productpurchase.bulkDelete') }}" style="display:inline;">
                        @csrf
...
$(document).ready(function () {
    ...
    $('#memberSearchInput').on('input', function () {
        ...
        memberTimer = setTimeout(function () {
            $.get("{{ route('productpurchase.member') }}", { member_id: val })
                .done(function (data) {
                    ...
                    if (data.results && data.results.length > 0) {
                        $.each(data.results, function (i, m) {
                            ...
                            item.on('click', function () {
                                ...
                                $.get("{{ route('productpurchase.memberWallet') }}", { member_id: selId })
                                    .done(function (res) {
                                        if (res.found) {
