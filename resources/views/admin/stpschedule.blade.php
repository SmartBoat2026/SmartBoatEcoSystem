        ...
        <div class="card-body table-responsive">
            ...
            <div id="bulkActionBar"
                ...
                <form id="bulkDeleteForm"
                      action="{{ route('stpschedule.bulkDelete') }}"
            ...
            <table id="stpSchedulesTable" class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $index + 1 }}</td>
                        <td>
                            <div style="font-weight:700;color:#1a3a6b;">{{ $schedule->member_id }}</div>
                        ...
                        <td style="white-space:nowrap;">{{ $schedule->start_date }}</td>
                        <td style="white-space:nowrap;">{{ $schedule->end_date }}</td>
                        <td>{{ Str::limit($schedule->running_hrs, 40) }}</td>
                        <td style="white-space:nowrap;">₹{{ number_format($schedule->per_hrs_amount, 2) }}</td>
                        <td style="white-space:nowrap;">₹{{ number_format($schedule->per_day_amount, 2) }}</td>
                        <td style="white-space:nowrap;font-weight:700;">₹{{ number_format($schedule->total_amount, 2) }}</td>
                        <td>
                            <form action="{{ route('stpschedule.toggleStatus', $schedule->id) }}"
                                  method="POST" style="display:inline;">
                                @csrf
                                <button type="submit"
                        ...
                        <td>
                            <div class="d-flex gap-1">
                                ...
                                <form action="{{ route('stpschedule.delete', $schedule->id) }}"
                                      method="POST" style="display:inline;"
    ...
    <div class="modal fade" id="editModal{{ $schedule->id }}" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{ route('stpschedule.update', $schedule->id) }}" method="POST">
                    @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="hidden" name="member_id"
                                       ...
                                       value="{{ $schedule->member_id }}" required>
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                ...
                                <input type="date" name="end_date"
                                       ...
                                       min="{{ $schedule->start_date }}" required>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-2">
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label fw-bold text-primary"
                                               for="edit_check_all_{{ $schedule->id }}" style="font-size:12px;">
                                            Select All (24hrs)
                                        </label>
                                    </div>
                                </div>
                                ...
                                <small id="edit_selected_hrs_label_{{ $schedule->id }}"
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                ...
                                <input type="text" name="per_day_amount"
                                       ...
                                       value="{{ $schedule->per_day_amount }}" readonly>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-4">
                                ...
                                <input type="text" name="total_amount"
                                       ...
                                       class="form-control fw-bold"
                                       style="background:#f8f9fa;"
                                       value="{{ $schedule->total_amount }}" readonly>
                            </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{ route('stpschedule.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                                        ...
                                        <div class="col-6 col-sm-4 col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input hr-checkbox"
                                                       ...
                                                       id="hr_{{ $h }}">
                                                <label class="form-check-label"
                                                       for="hr_{{ $h }}" style="font-size:11px;">
                                                    {{ $h }}hrs - {{ $h+1 }}hrs
                                                </label>
                                            </div>
                                        </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // 3. MEMBER SEARCH
    // ════════════════════════════════════════════════
    var searchUrl    = "{{ route('stpschedule.searchMember') }}";
    var searchTimers = {};
